...
export function FinalCTA() {
    ...
    return (
        <section id="contact" className="py-24 bg-navy-950 overflow-hidden relative">
            {/* Background Elements */}
            ...
            <div className="container-custom relative z-10">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <h2 className="text-4xl md:text-5xl md:leading-tight font-bold text-white mb-6">
                            {t('t1')} <br />
                        ...
                        <div className="glass-panel p-6 rounded-2xl inline-flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <a href="tel:+41798397979" className="text-xl font-bold text-white hover:text-primary-light transition-colors">
                                    +41 79 839 79 79
                                </a>
                            </div>
                        </div>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-navy-900 border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl"
                    >
